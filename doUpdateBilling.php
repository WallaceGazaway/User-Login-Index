...
$sql = "UPDATE P2Billing SET BillingID='".$BillingID."', BillName='".$BillName."', BillAddress='".$BillAddress."', BillCity='".$BillCity."', BillState='".$BillState."', BillZip='".$BillZip."', CardType='".$CardType."', CardNumber='".$CardNumber."', ExpDate='".$ExpDate."' WHERE Login= '{$_SESSION["Login"]}'";
